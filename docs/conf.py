...
# -*- coding: utf-8 -*-
#
# paperboy documentation build configuration file, created by
...
_version_py = os.path.join('..', 'paperboy', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'paperboy.tex', 'paperboy Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'paperboy', 'paperboy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'paperboy', 'paperboy Documentation',
     author, 'paperboy', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    paperboy_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'paperboy'))
