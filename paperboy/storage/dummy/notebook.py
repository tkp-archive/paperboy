...
class NotebookDummyStorage(NotebookStorage):
    ...
    def store(self, req, resp, session, *args, **kwargs):
        ...
        resp.content_type = 'application/json'
        store = Notebook.from_json(dict(name='MyNotebook', id='Notebook-1', user='Joe Python', userid='1', jobs=25, reports=353, created='10/14/2018 04:50:33', modified='10/14/2018 18:25:31'), self.config).store()
